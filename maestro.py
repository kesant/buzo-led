...
#definimos el modo con la variable
modo=0
#brightness :0-255
brightness=50                         
colors=[[brightness,0,0],                    #red
        ...
        [brightness,brightness,0],       #amarillo
        [0,0,0]]
np[0]=colors[0]
np.write()
time.sleep_ms(100)
...
def demo():
    ...
    def send_CMD(cmd):
        try:
            ...
            print("TX failed")
# se va a realizar la conexion de los dispositivos por bluetooth 
    ...
    with_response = False
    #se declara la entrada del adc del sensor
    ...
    while central.is_connected():
            ...
            time.sleep_ms(400 if with_response else 80)
